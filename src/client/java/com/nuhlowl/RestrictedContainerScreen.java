...
public class RestrictedContainerScreen extends HandledScreen<RestrictedContainerScreenHandler> {
    private static final Identifier TEXTURE = Identifier.ofVanilla("textures/gui/container/generic_54.png");
    private final int rows;

    public RestrictedContainerScreen(RestrictedContainerScreenHandler handler, PlayerInventory inventory, Text title) {
